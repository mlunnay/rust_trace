...
pub fn generate() -> Vec<Box<dyn Hittable>> {
    ...
    objects.push(Box::new(Cuboid::new(Vec3::new(555.0, 0.0, 0.0), Vec3::new(555.1, 555.0, 555.0), Rc::new(Lambertian::new(Rc::new(ConstantTexture::new(Vec3::new(0.12, 0.45, 0.15))))))));
    objects.push(Box::new(Cuboid::new(Vec3::new(-0.1, 0.0, 0.0), Vec3::new(0.0, 555.0, 555.0), Rc::new(Lambertian::new(Rc::new(ConstantTexture::new(Vec3::new(0.65, 0.05, 0.05))))))));
